System.register([], function (exports_1, context_1) {
    ...
    var MessageType, CorvinaHost, CorvinaConnectEventType, initHandshake, CorvinaConnect;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_1("CorvinaConnectEventType", CorvinaConnectEventType);
            initHandshake = ({ corvinaHostWindow, corvinaHost }) => {
                return new Promise((resolve, reject) => {
                    try {
                        corvinaHostWindow === null || corvinaHostWindow === void 0 ? void 0 : corvinaHostWindow.postMessage({ type: MessageType.CORVINA_CONNECT_INIT }, corvinaHost);
